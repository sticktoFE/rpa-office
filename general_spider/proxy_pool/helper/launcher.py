...
import sys
from general_spider.proxy_pool.db.dbClient import DbClient
...
def startServer():
    __beforeStart()
    from general_spider.proxy_pool.api.proxyApi import runFlask
...
def startScheduler():
    __beforeStart()
    from general_spider.proxy_pool.helper.scheduler import runScheduler
...
def __showVersion():
    from general_spider.proxy_pool.setting import VERSION
