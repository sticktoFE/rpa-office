...
from general_infor_extractor.defaults import ARTICLE_XPATH
from general_infor_extractor.utils import iter_node
    ...
    def classify_by_weight(self):
        ...
        for node in iter_node(body):
            ...
            if tag in ["h3", "h4", "p", "div"]:
                if "title" in class_ or "header" in class_ or "headline" in class_:
                    has_title = True
                    break
