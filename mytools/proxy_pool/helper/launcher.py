...
import sys
from mytools.proxy_pool.db.dbClient import DbClient
...
def startServer():
    __beforeStart()
    from mytools.proxy_pool.api.proxyApi import runFlask
    runFlask()


def startScheduler():
    __beforeStart()
    from mytools.proxy_pool.helper.scheduler import runScheduler
    runScheduler()
...
def __showVersion():
    from mytools.proxy_pool.setting import VERSION
