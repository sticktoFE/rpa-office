...
其中，用电脑操作手机使用adb工具，GUI设计使用PySide6，动作文件的存储使用json格式
...
import sys
import os
from PySide6.QtWidgets import QApplication, QMainWindow, QInputDialog, QFileDialog, QTreeWidgetItem
