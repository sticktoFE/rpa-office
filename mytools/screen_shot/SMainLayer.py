...
class SMainLayer(QLabel):  # 区域截图功能
    ...
    def init_parameters(self):
        ...
        self.old_pen = self.old_eraser = self.old_brush = self.old_backgrounderaser = [
            -2,
            -2,
        ]
    ...
    def search_in_which_screen(self):
        ...
        for i in screens:
            ...
            if mousepos[0] in range(rect[0], rect[0] + rect[2]) and mousepos[
                1
            ] in range(rect[1], rect[1] + rect[3]):
                secondscreen = i
                break
        print(
            "t",
