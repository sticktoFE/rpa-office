...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.actionStartPushButton, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.autoClickScreenShot, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.taskStopPushButton, 1, 1, 1, 1)
