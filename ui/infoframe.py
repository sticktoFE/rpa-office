...
class Ui_InfoWidget(object):
    def setupUi(self, InfoWidget):
        ...
        sizePolicy.setHeightForWidth(
            InfoWidget.sizePolicy().hasHeightForWidth())
        ...
        self.label_2.setStyleSheet(u"border-image: url(:/icon/006.png);")
    ...
    def retranslateUi(self, InfoWidget):
        InfoWidget.setWindowTitle(
            QCoreApplication.translate("InfoWidget", u"Form", None))
        self.label_2.setText("")
        self.label.setText(QCoreApplication.translate(
            "InfoWidget", u"\u8bc6\u522b\u6210\u529f", None))
